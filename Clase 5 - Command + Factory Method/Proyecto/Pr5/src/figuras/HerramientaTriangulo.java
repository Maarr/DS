...
public class HerramientaTriangulo implements Herramienta {
	...
	public void pinchar(int x, int y) {
		...
		if (vertices == 3) {
			Figura fig=new Triangulo(vertice[0], vertice[1], vertice[2]);
			editor.getDibujo().AddFigura(fig);
			editor.getHistorial().añadirCambio(new CambioCrear(fig,editor.getDibujo()));
			vertices = 0;
